...
public class StudentDAOImpl implements StudentDAO {
	...
	@Override
	public void createRecord(Student std) {
		...
		/*
		 * String query = "insert into student values(?,?,?)"; Object records[] = {
		 * std.getStudentId(), std.getStudentName(), std.getStudentAddress() }; int
		 * recordInserted = jdbcTemplate.update(query, records); return recordInserted;
		 */
	}
